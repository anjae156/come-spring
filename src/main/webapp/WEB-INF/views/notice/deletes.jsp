...
<h1>공략게시판관리 [글개수 : <%=count %>]</h1>
<form action="deletesProcess.jsp" method="post" onsubmit="return Check();">
<table id="notice">
  <tr>
  ...
  if (count > 0) {
	  for (BoardVO boardVO : boardList) {
		  ...
		  <tr >
		  	...
		  	<td class="left" onclick="location.href='content.jsp?num=<%=boardVO.getNum()%>&pageNum=<%=pageNum%>';">
		  		<%
		  	...
		  	<td><input type="checkbox" name="delnum" value="<%=boardVO.getNum()%>" /></td>
		  </tr>
